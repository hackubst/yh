...
class AcpOrderAction extends AcpAction
{
	...
	public function order_detail()
	{
		...
		try
		{
			$order_info = $order_obj->getOrderInfo($order_obj->list_fields . ', weight, system_discount_amount, user_address_id, user_remark, express_number, express_company_id, user_id, mobile, realname, province_id, city_id, area_id, address');
		}
		catch (Exception $e)
		{	
