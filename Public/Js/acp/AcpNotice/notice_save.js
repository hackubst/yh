...
KindEditor.ready( function (K) {
	var editor = K.create( 'textarea[name="contents"]' , {
		...
		afterUpload : function(url) {
			$('#J_KindEditor').append('<input type="hidden" name="notice_txt_images[]" value="' + url + '" />');
		}
	});
});
...
$(function(){
	...
	new AjaxUpload("#J_Uploader", {
		action: "/AcpNoticeAjax/uploadHandler",
		name: "imgFile",
		responseType: "json",
		onSubmit: function(){
			ajaxLoading.show().parent().removeClass('hide');
