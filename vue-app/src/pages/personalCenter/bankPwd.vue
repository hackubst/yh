<template>
    <div id="bankPwd">
        <input type="password" placeholder="请输入原银行密码" v-model="old_pwd">
        <input type="password" placeholder="请输入新的银行密码" v-model="new_pwd">
        <input type="password" placeholder="再次输入新的银行密码" v-model="confirm_pwd">
