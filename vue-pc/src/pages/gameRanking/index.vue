    ...
    <div id="gameRanking">
        <ul class="rank_list">
            <li class="list_type" v-for="(item, index) in rank_list" :key="index">
                ...
                <ul class="list_info" :class="index == 0?blue:(index == 1? red:white)">
  ...
  data () {
    return {
        rank_list:[{
            ...
            img: require('../../assets/images/img/pic_zuori@2x.png'),
            rank_list_second: [],
        },{
    ...
    get_rank_list() {
        this.$Api({
            ...
            if (!err) {
                ...
                this.rank_list[1].rank_list_second = res.yesterday_list
                this.rank_list[2].rank_list_third = res.sevenday_list
            } else {
