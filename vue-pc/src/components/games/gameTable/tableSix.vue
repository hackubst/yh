  ...
  <div class="tableSix">
    <table class="game_table" border="1" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th style="width: 144px;">乐豆总数</th>
        <th style="width: 104px;">中奖人数</th>
      ...
      <tr v-for="(gameItem, index) in gameResultList" :key="index">
        ...
        <td>
          <div class="douzi_all">
            ...
            {{gameItem.game_log_info.total_money | changeBigNum}}
          </div>
        </td>
        <td>
          <span>{{gameItem.game_log_info.win_people || 0}}/{{gameItem.game_log_info.bet_people || 0}}</span>
        </td>
        <td>
          <div
