<template>
  <div class="guessBet">
    ...
    >
      <tbody>
        <tr>
          <th colspan="4" class="two_th">前两和</th>
        </tr>
        <tr>
        ...
        <tr>
          <th colspan="4" class="two_th">后两和</th>
        </tr>
        <tr>
          <td v-for="(item, index) in modeNumsMore[2]" :key="index">
            <div class="td_box">
              <div class="box_title">{{item.name}}</div>
              <div class="box_rate">{{item.rate}}</div>
              <div class="box_inp">
    ...
    <div class="table_box" v-loading="loading">
      <table
        class="betting_table"
        cellspacing="0px"
        style="border-collapse:collapse; table-layout: fixed; width: 360px; border: none;"
      >
        <tbody>
          <tr>
            <th colspan="3" class="two_th">号码一</th>
          </tr>
      ...
      >
        <tbody>
          <tr>
            <th colspan="3" class="two_th">号码二</th>
          </tr>
      ...
      >
        <tbody>
          <tr>
            <th colspan="3" class="two_th">号码三</th>
          </tr>
